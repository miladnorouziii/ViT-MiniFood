...
class Main():
    ...
    def __init__(self, data):
        ...
        self.parser.add_argument("--model", type=str, help="The desired model path (stored in the Models folder).")
        ...
        self.parser.add_argument("--load", type=str, default=False, help="Model name to load.")
        self.parser.add_argument("--image", type=str, default=False, help="Image path to predict.")
